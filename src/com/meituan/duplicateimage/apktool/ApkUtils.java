...
public class ApkUtils {
    ...
    public static List<String> getApkImagesPath(final String apkDir, final String outDir) {
        ...
        try {
            decoder.setOutDir(new File(outDir + File.separator + Utils.getFilenameWithoutExtension(apkFile)));
            decoder.decode();
            String resFile = outDir + File.separator + apkFile.getName() + File.separator + "res";
            return null;
